...
//       { onClick: async () => await createSession({}) ,  name: "AI Assistance", href: "/chat" },
...
//   const hideLayout = /^\/chat\/[^/]+$/.test(pathname);
...
//       { name: "Home", href: "/" },
//       { name: "Masterclass", href: "/master-class" },
//       { name: "AI Assistance", href: "/chat" }, // Simplified, handle logic in click handler
//       { name: "Features", href: "/#features" },
//       { name: "Pricing", href: "/#prices" },
//       { name: "Testimonials", href: "/#testimonials" },
//     ],
...
//   // 5. Click handler for links: handle session creation for AI Assistance
...
//       try {
//         // Call the createSession mutation
...
//         // You could redirect to an error page or stay on the current page
//       }
//     } else if (href.startsWith("/#")) {
//       if (pathname === "/") {
...
export default function Header() {
  ...
  const hideLayout = useMemo(() => {
    // Check for exact matches in hideHeaderRoutes
    if (hideHeaderRoutes.includes(pathname)) return true;

    // Check for dynamic /chat/:id pattern
