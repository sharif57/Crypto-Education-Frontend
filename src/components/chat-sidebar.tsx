...
// import { useAllSessionsQuery, useCreateSessionMutation } from "@/Redux/feature/chatSlice";
...
//   const {data} = useAllSessionsQuery(undefined)
...
//               </button>
//               <button onClick={handleCreateSession} className="p-2 cursor-pointer rounded-full hover:bg-[#005163] transition-colors">
//                 <svg
//                   width="24"
//                   height="25"
//                   viewBox="0 0 24 25"
...
// import { Search } from "lucide-react";
// import Link from "next/link";
// import { useAllSessionsQuery, useCreateSessionMutation, useDeleteSessionMutation } from "@/Redux/feature/chatSlice";
// import { toast } from "sonner";
...
//                                 e.stopPropagation();
//                                 setActiveMenu(
//                                   activeMenu === `today-${chat.object_id}`
//                                     ? null
//                                     : `today-${chat.object_id}`
//                                 );
//                               }}
//                               className="opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 rounded-full hover:bg-[#006A82]"
//                             >
...
//                                 </button>
//                                 <button
//                                   onClick={() => handleDeleteSession(chat.object_id)}
//                                   className="w-full text-left px-3 py-2 text-sm hover:bg-[#005163] text-red-400"
//                                 >
//                                   Delete
//                                 </button>
...
//                                 e.stopPropagation();
//                                 setActiveMenu(
//                                   activeMenu === `yesterday-${chat.object_id}`
//                                     ? null
//                                     : `yesterday-${chat.object_id}`
//                                 );
//                               }}
//                               className="opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 rounded-full hover:bg-[#006A82]"
//                             >
...
//                                 e.stopPropagation();
//                                 setActiveMenu(
//                                   activeMenu === `previous-${chat.object_id}`
//                                     ? null
//                                     : `previous-${chat.object_id}`
//                                 );
//                               }}
//                               className="opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 rounded-full hover:bg-[#006A82]"
//                             >
...
//     try {
//       // Assuming useEditSessionMutation exists; replace with actual mutation
...
//                             className="flex-1 p-2 rounded bg-[#004050] text-white text-sm"
//                             autoFocus
//                           />
//                           <button
//                             onClick={(e) => {
...
//                             }}
//                             className="p-2 bg-[#005163] rounded text-sm hover:bg-[#006A82]"
//                           >
//                             Save
//                           </button>
//                           <button
...
//                             }}
//                             className="p-2 bg-gray-500 rounded text-sm hover:bg-gray-600"
//                           >
//                             Cancel
//                           </button>
//                         </div>
...
//                           className="w-full"
//                           onClick={(e) => {
//                             if (activeMenu === `today-${chat.object_id}`) {
//                               e.preventDefault(); // Prevent navigation when menu is open
//                             }
//                           }}
//                         >
//                           <Link href={`/chat/${chat.object_id}`}>
...
//                                     );
//                                     if (activeMenu !== `today-${chat.object_id}`) {
//                                       setEditTitle(chat.name); // Pre-fill edit input
//                                     }
//                                   }}
//                                   className="opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 rounded-full hover:bg-[#006A82]"
//                                 >
...
//                           className="w-full"
//                           onClick={(e) => {
//                             if (activeMenu === `yesterday-${chat.object_id}`) {
//                               e.preventDefault(); // Prevent navigation when menu is open
//                             }
//                           }}
//                         >
...
//                           className="w-full"
//                           onClick={(e) => {
//                             if (activeMenu === `previous-${chat.object_id}`) {
//                               e.preventDefault(); // Prevent navigation when menu is open
//                             }
//                           }}
//                         >
