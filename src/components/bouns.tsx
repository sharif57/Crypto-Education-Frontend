...
export default function Bouns() {
    ...
    return (
        <div className='p-4'>
            <h1 className="text-2xl font-semibold text-[#62C1BF] capitalize " >Referral Bonus history</h1>
            {invoices?.length === 0 ? (
                <p className='text-gray-500 text-center capitalize pt-10'>bonus not found</p>
            ) : (
                <div>
                    {/* Invoices Table */}
                    {invoices?.length > 0 && (
