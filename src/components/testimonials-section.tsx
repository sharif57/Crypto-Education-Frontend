      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
            What Our Learners Are <span className="text-[#4ade80]">Saying</span>
          </h2>
        ...
        {/* Testimonials Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 mt-[200px]">
          {/* Column 1 */}
          <div className="space-y-6 ">
            {/* Theresa Webb */}
            <div className="bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-text hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden hover:bg-text">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-lg text-white">Theresa Webb</span>
              </div>
              <p className="text-gray-300 font-normal text-lg leading-relaxed">
                TheClue&lsquo;s Telegram group is a total game-changer! Being part of this community allows me to access the
                latest tips and insights before anyone else. The instant updates and lively discussions keep me informed
                and...
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-text hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden hover:bg-text">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-lg text-white">Dianne Russell</span>
              </div>
              <p className="text-gray-300 text-lg font-normal  leading-relaxed">
                Being part of this community has completely transformed how I approach challenges. The shared knowledge
                and diverse perspectives have opened my eyes to new strategies and...
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 -mt-20">
            ...
            <div className="bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-text hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden hover:bg-text">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-lg text-white">Cameron Williamson</span>
              </div>
              <p className="text-gray-300 text-lg font-normal leading-relaxed">
                Joining TheClue was the best decision I ever made! The 360° learning experience offered here is truly
                unparalleled. From engaging workshops to hands-on projects, every aspect is designed to enhance...
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-text hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden hover:bg-text">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-lg text-white">Darlene Robertson</span>
              </div>
              <p className="text-gray-300 text-lg font-normal leading-relaxed">
                The clarity and direction I get from the live sessions are unmatched. Every question is met with
                thoughtful answers that actually move me forward. It&lsquo;s like having a personal mentor right there
                guiding...
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 lg:mt-0">
            ...
            <div className="bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-text hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden hover:bg-text">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-lg text-white">Darrell Steward</span>
              </div>
              <p className="text-gray-300 text-lg font-normal leading-relaxed">
                The energy in the weekly Q&A sessions is absolutely contagious! Each meeting is filled with vibrant
                discussions and insightful questions that inspire me to dive deeper into the topics. I always leave
                feeling...
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-text hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden hover:bg-text">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-semibold text-lg  text-white">Marvin McKinney</span>
              </div>
              <p className="text-gray-300 text-lg font-normal leading-relaxed">
                I&apos;ve never felt so supported in an online space before. The combination of expert advice and genuine
                peer connections creates an environment where I feel safe to ask questions...
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <Button className="bg-[#4ade80] hover:bg-[#22c55e] text-black font-semibold px-8 py-3 rounded-full text-lg transition-colors duration-200">
            Share Your Thought
          </Button>
        </div>
      </div>
