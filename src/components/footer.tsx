...
export default function Footer() {
  ...
  // Check if the current pathname matches any of the hideFooterRoutes or the dynamic /chat/:id pattern
  const hideLayout = useMemo(() => {
    // Check for exact matches in hideFooterRoutes
    if (hideFooterRoutes.includes(pathname)) return true;

    // Check for dynamic /chat/:id pattern
    return /^\/chat\/[^/]+$/.test(pathname);
  }, [pathname, hideFooterRoutes]);
