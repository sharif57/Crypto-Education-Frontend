...
export default function Chat() {
  ...
  return (
    <div>
      ...
      {/* AI Assistant Modal - Right Side Positioned */}
      {isAIModalOpen && (
        <div className="absolute  lg:top-2/5 top-0 h-[485px] border-text lg:right-12 right-0 lg:w-[400px] w-auto m-0 lg:m-5 z-20 rounded-xl border flex flex-col">
          {/* Modal Header */}
          <div className="flex items-center justify-between p-4 bg-[#62C1BF] rounded-t-xl text-[#224443]">
            <div className="flex items-center gap-2">
              <svg
          ...
          >
            ...
            {/* Invisible div to scroll to - removed as we're using scrollTop method */}
          </div>
