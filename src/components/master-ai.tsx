...
export default function MasterAi() {
  ...
  return (
 <section className="relative max-w-7xl mx-auto overflow-hidden rounded-none lg:rounded-3xl bg-gradient-to-r from-[#202020] to-[#307574] px-4 sm:px-6 lg:px-10">
  {/* Background Image */}
  <div
    className="
      absolute inset-0
  ...
  <div
    className="
      absolute inset-0 rounded-none lg:rounded-3xl
      bg-black/50
      sm:bg-black/40
      lg:bg-black/30
    "
