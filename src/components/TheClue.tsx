...
export default function TheClue() {
    ...
    return (
        <div className="">
            ...
            />
            <div id="the-clue" className="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 scroll-mt-24">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                    {/* Row 1 */}
                    {/* Global Access - Large Card */}
                    <div className="lg:col-span-1 lg:row-span-2">
                        <div className="h-full bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e] rounded-3xl  border border-[#303030] hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden">
                            {/* Subtle glow effect */}
                    ...
                    <div className="lg:col-span-1">
                        <div className="h-full  bg-gradient-to-br from-[#1c1c1c] to-[#2e2e2e]  rounded-3xl p-8 border border-[#303030] hover:border-cyan-400/40 transition-all duration-300 group relative overflow-hidden">
